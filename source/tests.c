...
void test_ecc(void)
{
    ...
    crypto_ecc256_make_key_pair(public_key,
                                &pub_size,
                                private_key,
                                &priv_size
                                );
    NRF_LOG_DEBUG("public key");
    NRF_LOG_HEXDUMP_DEBUG(public_key, NRF_CRYPTO_ECC_SECP256R1_RAW_PUBLIC_KEY_SIZE);
    
    NRF_LOG_DEBUG("private key");
    NRF_LOG_HEXDUMP_DEBUG(private_key, NRF_CRYPTO_ECC_SECP256R1_RAW_PRIVATE_KEY_SIZE);
