...
/** 
 * @brief		decode apdu command from raw package
 * 
 * @param[in]   data  data to decode
 * @param[in]   len   length of data
 * @param[out]  apdu  decoded apdu output
 *
 * @return 		0 if success
 */
...
#define SW_GET_RESPONSE \
    0x6100  // Command successfully executed; 'XX' bytes of data are available and can be requested using GET RESPONSE.
